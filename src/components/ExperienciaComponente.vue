<script setup>
import icono1 from '/src/assets/nihuiliv.jpeg';
import icono2 from '/src/assets/nihuili.jpeg';

import { ref } from 'vue';
const titulo = 'Técnico Electromecánico';
const fecha = 'Desde Marzo 2024 Hasta Septiembre 2024';
const experiencias = ref([
    { id: 1, src: icono1, parrafo: 'Técnico Junior en el área de Servicios Generales dentro de la empresa PampaEnergía, en la zona de Valle Grande, exactamente en la central hidroeléctrica Nihuil IV.' },
    { id: 2, src: icono2, parrafo: 'Técnico Junior en el área de Mecánicos dentro de la empresa PampaEnergía, en la zona de El Nihuil, exactamente en las centrales hidroeléctricas Nihuil I y Nihuil II.' },
]);
</script>
